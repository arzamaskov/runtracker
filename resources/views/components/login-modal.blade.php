    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center p-4">
        <div class="bg-background rounded-2xl shadow-2xl w-full max-w-md">
            ...
            <div class="flex items-center justify-between p-6 border-b border-border">
                <h2 class="text-2xl font-bold font-display">Вход</h2>
            ...
            <div class="p-6">
                <form class="space-y-4">
                    {{-- Email --}}
                    <div class="space-y-2">
                        <label for="login-email" class="text-sm font-medium text-foreground flex items-center gap-2">
                    ...
                    {{-- Password --}}
                    <div class="space-y-2">
                        <label for="login-password" class="text-sm font-medium text-foreground flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-primary">
                    ...
                    <p class="text-sm text-center text-muted-foreground">
                        Нет аккаунта?
                        <button type="button" data-open-modal="register-modal" data-modal-close class="text-primary hover:underline">
                            Зарегистрироваться
                        </button>
                    </p>
                </form>
